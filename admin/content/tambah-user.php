<?php
    if (isset($_POST['simpan'])) {
        ...
        //MASUKKAN KE DALAM TABEL USER (YANG AKAN DIMASUKKAN) VALUES (INPUTAN MASING-MASING KOLOM)

        $insert = mysqli_query($koneksi, "INSERT INTO user (nama_lengkap, id_level, email, password)
...
<body>
    <form action="" method="post">
        ...
        <div class="mb-3">
            <?php $queryOpt = mysqli_query($koneksi, "SELECT * FROM level");
            // var_dump($row); ?>
